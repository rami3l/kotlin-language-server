...
object ExtractSymbolVisibility : DeclarationDescriptorVisitor<Symbol.Visibility, Unit> {
    private fun convert(visibility: DescriptorVisibility): Symbol.Visibility =
    ...
    override fun visitConstructorDescriptor(desc: ConstructorDescriptor, nothing: Unit?) =
        convert(desc.visibility)
    ...
    override fun visitPackageViewDescriptor(desc: PackageViewDescriptor, nothing: Unit?) =
        Symbol.Visibility.PUBLIC

    override fun visitFunctionDescriptor(desc: FunctionDescriptor, nothing: Unit?) =
        convert(desc.visibility)

    override fun visitModuleDeclaration(desc: ModuleDescriptor, nothing: Unit?) =
        Symbol.Visibility.PUBLIC

    override fun visitClassDescriptor(desc: ClassDescriptor, nothing: Unit?) =
        convert(desc.visibility)
    ...
    override fun visitTypeParameterDescriptor(desc: TypeParameterDescriptor, nothing: Unit?) =
        Symbol.Visibility.PUBLIC

    override fun visitScriptDescriptor(desc: ScriptDescriptor, nothing: Unit?) =
        convert(desc.visibility)

    override fun visitTypeAliasDescriptor(desc: TypeAliasDescriptor, nothing: Unit?) =
        convert(desc.visibility)
    ...
    override fun visitPropertyDescriptor(desc: PropertyDescriptor, nothing: Unit?) =
        convert(desc.visibility)
}
