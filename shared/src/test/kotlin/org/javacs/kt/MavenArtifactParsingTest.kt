...
class MavenArtifactParsingTest {
    ...
    fun `parse maven artifacts`() {
        assertThat(
            parseMavenArtifact("net.sf.json-lib:json-lib:jar:jdk15:2.4:compile"),
            equalTo(
                Artifact(
        ...
        assertThat(
            parseMavenArtifact("org.codehaus.mojo:my-project:1.0"),
            equalTo(
                Artifact(
        ...
        assertThat(
            parseMavenArtifact("io.vertx:vertx-sql-client:test-jar:tests:3.8.0-SNAPSHOT:compile"),
            equalTo(
                Artifact(
                    group = "io.vertx",
    ...
    fun `parse maven sources`() {
        assertThat(
            parseMavenSource("org.springframework.boot:spring-boot-starter:jar:sources:2.4.5"),
            equalTo(
                Artifact(
