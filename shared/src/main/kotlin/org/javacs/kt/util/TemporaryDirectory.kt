...
/**
 * A directory in which temporary files may be created. The advantage of using this class over a
 * standard function such as Files.createTempFile is that all temp files in the directory can easily
 * be disposed of once no longer needed.
 */
